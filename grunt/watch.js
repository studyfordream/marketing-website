module.exports = {
  ...
  jsPPC: {
    ...
    tasks: ['config:dev', 'jshint:clientDev', 'jshint:server', 'modernizr', 'concat:namespacePPCPages', 'concat:ppcBundle', 'concat:jqueryModernizrPPC', 'copy:ppcUITest', 'clean:postBuild']
  },
  sass: {
